package com.socialstack.account.modelTest;
...
public class UserTest {
    ...
    public static final String EXPECTED_USERNAME = "Shahriar Kabir";
    public static final String EXPECTED_PASSWD = "shahriar1";
