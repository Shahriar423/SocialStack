    ...
    <div class="row">
                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Social Stack </a>
                            <i class="brand_network"><small><small>cacherabbit</small></small></i>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@socialstack.com</p>
                                                        <div class="divider">
                                                        </div>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>find your passion and you'll never work a day in your life.”</p>
                            <hr>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@socialstack.online</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="post-content">
                        ...
                        <p>Achieving success in DevOps requires an organizational commitment to cultural change, investment in automation, and the establishment of effective communication and collaboration practices. By fostering a culture that emphasizes shared responsibility, continuous learning, and alignment with business goals, organizations can reap the full benefits of DevOps—enhanced efficiency, faster delivery of high-quality software, and a more responsive approach to changing customer needs and marketplace demands.</p>
                    </div>
                    <hr>
                    <div>
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    ...
                                    <h4><a href="#" style="text-decoration:none;"><strong>Shahriar Kabir</strong></a></h4>
                                    <hr>
                                    <div class="post-content">
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    ...
                                    <h4><a href="#" style="text-decoration:none;"><strong>Shimul</strong></a></h4>
                                    <hr>
                                    <div class="post-content">
