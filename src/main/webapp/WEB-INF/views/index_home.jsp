                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">CacheRabbit</a>
                            <i class="brand_network"><small><small>New</small></small></i>
                        </div>
...
<div>
<blockquote><p>
     <h2 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">Stay Positive</h2>
     <h3 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">Find your passion and you'll never work a day in your life.</h3> 
</blockquote>
<!-- Page content -->
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;"> SocialStack is a comprehensive user and role management system designed to facilitate the creation and management of user profiles within social applications. Developed using Java with the Spring framework, SocialStack aims to provide seamless user registration, profile customization, and secure role-based access control, making it an essential tool for any social platform
	    </p>
	    <p><strong>Address:</strong>  DHAKA, Bangladesh</p> 
	    <p><strong>Phone No: </strong>  0187xxxxx</p>
		<p><strong>E-Mail ID :</strong> socialstack.com </p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2024 <a href="#"  target="_blank" class="w3-hover-text-green"> socialstack.com</a></p>
</footer>
